...
public class MokouTutorials extends FtueTip {

    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString("MokouMod:MokouTutorials");
