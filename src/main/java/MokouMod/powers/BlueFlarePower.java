...
public class BlueFlarePower extends AbstractPower {

    public static final String POWER_ID = MokouMod.makeID(BlueFlarePower.class.getSimpleName());
    ...
    public BlueFlarePower(AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
