...
/import MokouMod.powers.RecklessAttackPower;
...
public class CardCostModificationPatches {
    ...
    public static class RecklessAttackPatch {
        ...
        public static boolean patch(boolean __result, AbstractCard __instance) {
            return __result || (isIndeedWithoutADoubtInCombat() && mokouUtils.p().hasPower(RecklessAttackPower.POWER_ID));
        }
    }

    private static boolean isIndeedWithoutADoubtInCombat() {
        return (mokouUtils.p() != null && AbstractDungeon.currMapNode != null && (AbstractDungeon.getCurrRoom()).phase == AbstractRoom.RoomPhase.COMBAT);
    }
}
*/