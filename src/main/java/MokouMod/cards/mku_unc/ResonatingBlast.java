...
import MokouMod.powers.ResonatingBlastPower;
...
public class ResonatingBlast extends abs_mku_card {
    private final static CardInfo cardInfo = new CardInfo(
            ResonatingBlast.class.getSimpleName(),
            COSTS[1],
            CardType.POWER,
            CardTarget.SELF
    );
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        doPow(p, new ResonatingBlastPower(p, this.magicNumber));
...
public class ResonatingBlast extends abs_mku_card {
    ...
    public static final String ID = MokouMod.makeID(ResonatingBlast.class.getSimpleName());
    ...
    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        mokouUtils.doPow(mokouUtils.p(), new ResonatingBlastPower(mokouUtils.p(), magicNumber));
    }
