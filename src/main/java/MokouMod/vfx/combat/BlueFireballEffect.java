...
public class BlueFireballEffect extends AbstractGameEffect {
    ...
    public BlueFireballEffect(float startX, float startY, float targetX, float targetY, int timesUpgraded) {
    ...
    public void update() {
        ...
        if (this.vfxTimer < 0.0F) {
            ...
            AbstractDungeon.effectsQueue.add(new MokouMod.vfx.general.RedFireBurstParticleEffect(this.x, this.y, this.timesUpgraded));
            AbstractDungeon.effectsQueue.add(new MokouMod.vfx.general.RedFireBurstParticleEffect(this.x, this.y, this.timesUpgraded));
        }
