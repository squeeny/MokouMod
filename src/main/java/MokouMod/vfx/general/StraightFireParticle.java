...
public class StraightFireParticle extends AbstractGameEffect {
    ...
    public StraightFireParticle(float x, float y, float maxHeight, int Ignite) {
        ...
        if(p().hasPower(BlueFlarePower.POWER_ID) && Ignite == 0) { this.color = new Color(MathUtils.random(0.1F, 0.3F), MathUtils.random(0.2F, 0.4F), MathUtils.random(0.7F, 1.0F), 0.0F); }
