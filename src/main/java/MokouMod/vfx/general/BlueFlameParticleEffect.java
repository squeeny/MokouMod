...
public class BlueFlameParticleEffect extends AbstractGameEffect {
    ...
    public BlueFlameParticleEffect(float x, float y) {
        this.setImg();
        ...
        var10000 = this.color;
        var10000.r -= this.color.g - MathUtils.random(0.5F);
