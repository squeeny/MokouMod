...
public class BetterGiantFireEffect extends AbstractGameEffect {
    ...
    public void update() {
        ...
        } else if (this.startingDuration - this.duration < 0.75F) { this.color.a = Interpolation.fade.apply(0.0F, this.brightness, (this.startingDuration - this.duration) / 0.75F);
        } else if (this.duration < 1.0F) { this.color.a = Interpolation.fade.apply(0.0F, this.brightness, this.duration / 1.0F);
        }
    }
    private void setImg() {
